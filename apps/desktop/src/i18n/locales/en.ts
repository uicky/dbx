export default {
  ...
  ai: {
    ...
    suggestionExplain: "Explain this SQL",
    suggestionOptimize: "Optimize query performance",
    suggestionWrite: "Write a query for me",
    suggestionConnectFirst: "Connect a database first",
  },
  contextMenu: {
  ...
  settings: {
    ...
    appLayoutModern: "Modern bento",
    appLayoutModernDescription: "More independent activity rail, floating sidebar, and card-based workspace.",
    appLayoutSeparated: "Modern separated",
    appLayoutSeparatedDescription: "Clearer panel separation that fits the current workbench layout.",
    appLayoutClassic: "Classic compact",
    appLayoutClassicDescription: "Continuous tab bar with a tighter traditional layout.",
