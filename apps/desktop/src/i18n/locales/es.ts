...
export default withEnglishFallback({
  ...
  editor: {
    ...
    unsavedChangesMessage: "Esta pestaña tiene cambios sin guardar que se perderán si se cierra. ¿Guardar antes de cerrar?",
  ...
  settings: {
    ...
    updateDownloadSourceDescription: "Elige de dónde se descargan los instaladores de actualización. Se recomienda la fuente oficial; CNB puede ser más rápida en redes de China continental.",
