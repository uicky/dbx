...
export default withEnglishFallback({
  ...
  editor: {
    ...
    unsavedChangesMessage: "Esta aba tem alterações não salvas que serão perdidas se fechada. Salvar antes de fechar?",
  ...
  settings: {
    ...
    updateDownloadSourceDescription: "Escolha de onde os instaladores de atualização no aplicativo são baixados. A fonte oficial é recomendada; a CNB pode ser mais rápida em redes da China continental.",
