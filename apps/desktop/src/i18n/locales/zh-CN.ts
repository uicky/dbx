export default {
  ...
  ai: {
    ...
    suggestionExplain: "解释这条 SQL",
    suggestionOptimize: "优化查询性能",
    suggestionWrite: "帮我写一个查询",
    suggestionConnectFirst: "请先连接数据库",
  },
  contextMenu: {
    openConnection: "打开连接",
  ...
  settings: {
    ...
    appLayout: "界面布局",
    appLayoutModern: "现代 Bento",
    appLayoutModernDescription: "使用更独立的活动栏、浮岛式侧栏和卡片式工作区。",
    appLayoutSeparated: "现代分隔",
    appLayoutSeparatedDescription: "保持清晰分区，适合当前工作台式结构。",
    appLayoutClassic: "经典紧凑",
    appLayoutClassicDescription: "保留连续标签栏和更紧凑的传统布局。",
